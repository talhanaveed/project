...
<div id="body" >
			...
			<div class="row">
				...
				<div id="mid-header">
	        		...
	        		<div class="menu">
	        			...
	        			<ul>
				          <li class="first"><a href="#intro" class="intro">Introduction</a></li>
				          <li><a href="#info-collected" class="info-collected">Information Collected</a></li>
				          <li><a href="#uses-sharing-per-info" class="uses-sharing-per-info">Uses &amp; Sharing of Personal Info</a></li>
				          <li><a href="#choices-oblig" class="choices-oblig">Your Choices &amp; Obligations</a></li>
				          <li><a href="#important-info" class="important-info">Important Information</a></li>
				        </ul>
	       			...
	       			<div class= "section">
 					    ...
 					    <table>
 					    	<tr>
		       				...
		       				<div class="brief">
		       					<p>Our mission is to connect the world's professionals to enable them to be more productive and successful.</p>

		       					<p>We protect your personal information using industry-standard safeguards.  We may share your information with your consent or as required by law as detailed in this policy, and we will always let you know when we make significant changes to this Privacy Policy.</p>
		       				</div>
		       					</td>
		       					<td style="vertical-align:top">
		       				<div class="full">
						        ...
						        <ul>
						          <li>We protect your personal information and will only provide it to third parties: (1) with your consent; (2) where it is necessary to carry out your instructions; (3) as reasonably necessary in order to provide LinkedIn features and functionality to you; (4) as we reasonably believe is permitted by law or regulation; or (5) as necessary to enforce our User Agreement or protect the rights, property, or safety of LinkedIn, its Members, and the public.</li>
						        ...
						        <p>We may modify this Privacy Policy from time to time, and if we make material changes to it, we will provide notice through our website, apps, or other services  ("LinkedIn" or "Service") or by other means so that you may review the changes before you continue to use LinkedIn. If you object to any changes, you may close your account. Continuing to use LinkedIn after we publish or communicate a notice about any changes to this Privacy Policy means that you are consenting to the changes.</p>
						    </div><!--full-->
						    	</td>
						    </tr>
						</table>
			  ...
			  <div class="section">
			    ...
			    <h2 id="info-collected">1. What information we collect</h2>

			    <div class="row first">
			      <h3 class="copy-header">1.1. Data Controllers</h3>
			      <div class="brief">
			    ...
			    <div class="row">
			      <h3 class="copy-header">1.3. Profile Information</h3>
			      <div class="brief">
			    ...
			    <div class="row">
			      <h3 class="copy-header">1.6. Using the LinkedIn Site and Applications</h3>
			      <div class="brief">
			        <p>We collect information when you visit LinkedIn, use our mobile applications, and interact with advertising on LinkedIn.</p>
			      </div>
			      <div class="full">
			        <p>We collect information when you use the LinkedIn website, LinkedIn applications (for example, LinkedIn for iPhone or Android), and LinkedIn platform technology (such as "Share on LinkedIn" plugins for publishers). For example, we collect information when you view or click on ads, import your address book, join and participate in groups, participate in polls, install a LinkedIn mobile application, and share articles on LinkedIn.</p>
			      </div>
			    </div>
			    ...
			    <div class="row">
			      <h3 class="copy-header">1.8. Cookies</h3>
			      <div class="brief">
			    ...
			    <div class="row">
			      ...
			      <div class="full">
			        ...
			        <ul>
			          <li>Advertising technologies like web beacons, pixels, ad tags, cookies, and mobile identifiers as permitted by mobile platforms both on and off LinkedIn;</li>
			          <li>Member-provided profile information and categories (for example, "product managers in Texas");</li>
			          <li>Information inferred from a Member's profile (for example, using job titles to infer age, industry, seniority, and compensation bracket; or names to infer gender);</li>
			          <li>Your use of LinkedIn (for example, your LinkedIn search history) or clicking on a LinkedIn ad;</li>
			          <li>Information from advertising partners which we use to help deliver ads more relevant to you.</li>
			        </ul>
  ...
  <div class="section">
    ...
    <h2 id="uses-sharing-per-info">2. How we use your personal information</h2>

    <div class="row first">
      <div class="full-no-brief">
        <p>At LinkedIn, we take pride in our mantra of "Members first," which means that above all else we strive to use your information to provide you world-class services in a professional and trustworthy manner.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.1. Consent to LinkedIn Processing Information About You</h3>
      <div class="brief">
    ...
    <div class="row">
      <h3 class="copy-header">2.2. LinkedIn Communications</h3>
      <div class="brief">
        <p>We communicate with you using LinkedIn messaging, email, and other ways available to us. We may send you messages relating to the availability of the Services, security, or other service-related issues. We also may send promotional InMail messages to your LinkedIn inbox. You can change your email settings at any time.</p>
      </div>
      <div class="full">
        <p>We communicate with you through email, notices posted on the LinkedIn website, messages to your LinkedIn inbox, and other means available through the Service, including mobile text messages and push notifications. Examples of these messages include: (1) welcome and engagement messages - when you register on LinkedIn, we may send you a series of emails to inform you about how to best use LinkedIn as well as new features; (2) service messages – these will cover service availability, security, and other issues about the functioning of LinkedIn; (3) promotional messages – these include both email and InMail messages (InMail messages are only delivered to your LinkedIn InBox), and may contain promotional information directly or on behalf of our partners, including job opportunities and information from companies that are hiring.  These messages will be sent to you based on your profile information and messaging preferences. LinkedIn tracks the open rate of your InMails to provide your InMail acceptance score. You may change your email and contact preferences at any time by signing into your account and changing your email <a href="https://www.linkedin.com/settings/?tab=email">settings</a>. You can also opt out of promotional messages by sending a request to LinkedIn <a href="http://linkedin.custhelp.com/">Help Center</a>. Please be aware that you cannot opt out of receiving service messages from LinkedIn.</p>
      </div>
    </div>
    <div class="row">
      <h3 class="copy-header">2.3. User Communications</h3>
      <div class="brief">
        <p>With certain communications you send on LinkedIn, the recipient can see your name, email address, and some network information.</p>
      </div>
      <div class="full">
        <p>Many communications that you initiate through LinkedIn (for example, an invitation sent to a non-Member) will list your name and primary email address in the header of the message. Messages you initiate may also provide the recipient with aggregate information about your network (for example, how many people are in your network). Other communications that you initiate through the Services, like a request for an introduction, will list your name as the initiator but will not include your personal email address contact information. Once you have connected with an individual, regardless of who sent the invitation, your contact information will be shared with that individual.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.4. Customized Content</h3>
      <div class="brief">
        <p>We use the information you provide on your profile to customize your experience on LinkedIn.</p>
      </div>
      <div class="full">
        <p>We use information that you provide to us to customize your experience and the experiences of others on LinkedIn. For example, when you sign in to your account, we may display the names of new Members who have recently joined your network or recent updates from your connections and companies you follow. We also use aggregated information from your network to show you content, such as news relevant to you, your industry, or your profession.</p>
      </div>
    </div>

    <div class="row">
      <div class="full-no-brief">
        <h3>2.5. Sharing Information with Affiliates</h3>
        <p>We may share your personal information with our LinkedIn affiliates outside of the LinkedIn entity that is your data controller (for example, LinkedIn Corporation may share your information with LinkedIn Ireland Limited, or other LinkedIn operating entities) as necessary to provide the Services. By agreeing to this Privacy Policy, you are consenting to this sharing.</p>
        <p>Additionally, if you opt-in to binding your LinkedIn account with SlideShare.net, a site owned by LinkedIn but operating under its own user agreement and privacy policy, both LinkedIn and SlideShare.net will receive and share information about your use of their respective services to improve your experience on each. For example, SlideShare will be able to recommend better content to you based on your LinkedIn content preferences.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.6. Sharing Information with Third Parties</h3>
      <div class="brief">
        <p>Any information you put on your profile and any content you post on LinkedIn may be seen by others. We don't provide any of your non-public information (like your email address) to third parties without your consent, unless required by law, or as described in Sections 2.6 and 2.14 of this Policy. Other people may find your LinkedIn profile information through search engines (you can choose which parts of your public profile are accessible to public search engines in your settings), or use services like Twitter in conjunction with your LinkedIn account.</p>
      </div>
      <div class="full">
        <p>LinkedIn offers a "public profile" feature that allows Members to publish portions of their LinkedIn profile to the public Internet. This public profile will be indexed and displayed through public search engines when someone searches for your name. You may choose the parts of your profile that search engines index or completely opt out of this feature in your <a href="/profile/public-profile-settings">settings</a>. However, third-party search engines may not automatically update their caches, which may contain old public profile information. Unless you delete it, your profile on LinkedIn is always viewable on the LinkedIn Services.</p>
        <p>We do not rent or sell personal information that you have not posted on LinkedIn, except as described in this Privacy Policy. We will not disclose personal information that is not published to your profile or generated through engagement with other LinkedIn services, such as Groups and Company Pages, without your consent or to carry out your instructions (for example, to process payment information) unless LinkedIn has a good faith belief that disclosure is permitted by law or is reasonably necessary to: (1) comply with a legal requirement or process, including, but not limited to, civil and criminal subpoenas, court orders or other compulsory disclosures; (2) enforce this Privacy Policy or our User Agreement; (3) respond to claims of a violation of the rights of third parties; (4) respond to Member service inquiries; or (5) protect the rights, property, or safety of LinkedIn, our Members, or the public. See Section 2.14 for additional details about LinkedIn's compliance with legal requests for information.</p>
        <p>
          LinkedIn supports middleware providers that offer archiving solutions to firms subject to financial services regulation, which, with your permission, facilitate the archiving of your communications and other LinkedIn activity by a third party for compliance purposes.
          ...
          Further, LinkedIn allows third parties to look-up profile information (subject to your privacy settings) using your email address or first and last name information through its profile API (see Section 2.7. below).
        </p>
        <p>Third parties (for example, your email provider) may give you the option to upload certain information in your LinkedIn contacts onto their own service.  If you choose to share your LinkedIn contacts, you will be granting your third party provider the right to store, access, disclose and use your LinkedIn contacts in the ways described in such third party's terms and privacy policy.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.7. Developers Using LinkedIn Platform Services</h3>
      <div class="brief">
        <p>We work with developers to build Platform Applications using LinkedIn's developer tools. Whether you use Platform Applications is up to you. If you have given a Platform Application access to your LinkedIn account, you can revoke that permission anytime. Also, you can opt out of providing information to developers through your connections.</p>
      </div>
      <div class="full">
        <p>We collaborate with and allow third parties to use LinkedIn's developer platform to offer services and functionality in conjunction with LinkedIn. These third-party developers have either negotiated an agreement to use LinkedIn platform technology or have agreed to our self-service API and Plugin terms in order to build applications ("Platform Applications"). Both the negotiated agreements and our API and Plugin terms contain restrictions on how third parties may access, store, and use the personal information you provide to LinkedIn. If you choose to use a Platform Application, you will be asked to confirm acceptance of the privacy policy and user agreement of the third-party developer. To revoke permission granted to a Platform Application, please visit your <a href="https://www.linkedin.com/settings/">settings</a>. Note, however, that even if you revoke the permission granted to a Platform Application, your connections may still be using the Platform Application, so the Platform Application may still have access to certain information about you, just as your connections do. You may opt out of providing information to third-party developers through your connections by accessing the "<a href="https://www.linkedin.com/settings/?tab=groups&amp;modal=nsettings-data-sharing">Turn on/off data sharing with third-party applications</a>" control in the "Groups, Companies, and Applications" tab under <a href="https://www.linkedin.com/settings/?tab=groups">settings</a>.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.8. Polls and Surveys</h3>
      <div class="brief">
        <p>We conduct our own surveys and polls and also help third parties do this type of research. Your participation in surveys or polls is up to you. You may also opt out of getting invitations to participate in surveys.</p>
      </div>
      <div class="full">
        <p>Polls and Surveys may be conducted by LinkedIn, Members, or third parties. Some third parties may target advertisements to you on the results page based on your answers in the poll. LinkedIn or third parties may follow up with you via InMail regarding your participation unless you have opted out of receiving InMail messages. We may use third parties to deliver incentives to you to participate in surveys or polls. If the delivery of incentives requires your contact information, you may be asked to provide personal information to the third party fulfilling the incentive offer, which will be used only for the purpose of delivering incentives and verifying your contact information. It is up to you whether you provide this information, or whether you desire to take advantage of an incentive. Your consent to use any personally identifiable information for the purposes set forth in the poll or survey will be explicitly requested by the party conducting it. LinkedIn is a member of the Council of American Survey Research Organizations ("CASRO") and abides by CASRO guidelines for market research. You may opt out of participating in surveys by changing your <a href="https://www.linkedin.com/settings/?tab=email&amp;modal=nsettings-research-invitations">settings</a> to stop receiving these inquiries and requests.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.9. Search</h3>
      <div class="brief">
        <p>LinkedIn helps you search for other professionals, companies, groups, professional content, and jobs.</p>
      </div>
      <div class="full">
        <p>You can search for Members, employment opportunities, information about companies, and community content from LinkedIn Groups on LinkedIn. For example, you can find Members with particular expertise or experience, or Members that you may know from your industry or profession. You can also find employment opportunities and information about companies. You can also find content from LinkedIn Groups and LinkedIn Today.  We use personal information from LinkedIn, including Member profiles, Groups content, and Company Pages, to inform and refine our search service.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.10. Groups</h3>
      <div class="brief">
        <p>You are responsible for any information you post on LinkedIn, and this content will be accessible to others.</p>
      </div>
      <div class="full">
        <p>If you participate in LinkedIn Groups, share content on your Network Update Stream, or import a blog or other content, you should be aware that any information you choose to disclose using these services can be read, collected, and used by other Members in these forums, developers, and other third parties. LinkedIn is not responsible for the information you choose to submit in these forums. Some content in LinkedIn Groups may be public and searchable on the Internet if the group owner has not closed the group for public discussions. You can identify closed groups by the padlock icon next to the group name. You can remove your LinkedIn Groups posts at any time. However, others may have copied and used the information that you shared.</p>
      </div>
    </div>

    <div class="row">
      <div class="full-no-brief">
        <h3>2.11. Testimonials and Advertisements Placed through LinkedIn Ads</h3>
        <p>If you provide any testimonials about our goods or services or place advertisements through the LinkedIn Ads, we may post those testimonials and examples of advertisements you place in connection with our promotion of these services to third parties. Testimonials and advertisements may include your name and other personal information that you have provided. For more information about LinkedIn Ads, please see the <a onclick="LI.popup(this.href); return false;" href="/legal/pop/pop-sas-terms">LinkedIn Ads Terms of Use</a>.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.12. Recruiters</h3>
      <div class="brief">
      ...
      <div class="full">
        <p>We offer customized people-search functionality along with organizational and communications tools as part of our "LinkedIn Recruiter" premium service. LinkedIn Recruiter allows subscribers – generally, enterprises and professional organizations - to export limited information from Members' public profiles, such as name, headline, current company, current title, and location (for example, San Francisco Bay Area), in order to effectively manage candidate sourcing. You may limit or prevent LinkedIn Recruiter subscribers from exporting your profile information by configuring your <a href="/profile/public-profile-settings">public profile visibility settings</a> to restrict access to these fields. We do not provide email or other contact information to Recruiter subscribers. However, if you post that information as part of your profile it will be available to others. A LinkedIn Recruiter subscriber may also manage and store information it has independently obtained about you outside of the Service, such as a resume, in its licensed LinkedIn Recruiter platform. Any personal information obtained independently of LinkedIn services are not under LinkedIn's control but are subject to the policies of the LinkedIn Recruiter subscriber. We store such information on behalf of the LinkedIn Recruiter subscriber who can remove it at any time. We do not further process such information.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.13. Pages for Companies, Schools, Influencers, and Other Entities</h3>
      <div class="brief">
        <p>Companies and other entities can create pages on LinkedIn. If you follow one of these pages, you'll be listed as one of the company's followers, and non-identifiable information about you will be provided to the page's administrators.</p>
      </div>
      <div class="full">
        <p>LinkedIn allows companies, schools, charities, and other organizations as well as thought leaders and influencers to create pages dedicated to their brand, business, and mission. These pages are public, and any communications or information shared through them will be accessible by the entity that created them.  If you follow a page, you will be listed among the page's followers, which can be viewed by others. LinkedIn uses aggregate information about followers and viewers to provide data about the page's performance (for example, visits and updates).</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">2.14. Compliance with Legal Process and Other Disclosures</h3>
      <div class="brief">
        <p>We may disclose your personal information if compelled by law, subpoena, or other legal process, or if necessary to enforce our User Agreement.</p>
      </div>
      <div class="full">
        <p>It is possible that we may need to disclose personal information, profile information, or information about your activities as a LinkedIn Member when required by law, subpoena, or other legal process, or if LinkedIn has a good faith belief that disclosure is reasonably necessary to (1) investigate, prevent, or take action regarding suspected or actual illegal activities or to assist government enforcement agencies; (2) enforce the User Agreement, investigate and defend ourselves against any third-party claims or allegations, or protect the security or integrity of our Service; or (3) exercise or protect the rights, property, or safety of LinkedIn, our Members, personnel, or others.</p>
      </div>
    </div>

    <div class="row last">
      <h3 class="copy-header">2.15. Disclosures to Others as the Result of a Change in Control or Sale of LinkedIn Corporation</h3>
      <div class="brief">
        <p>If there is a change in control or sale of all or part of LinkedIn, we may share your information with a third party, who will have the right to use that information in line with this Privacy Policy.</p>
      </div>
      <div class="full">
        <p>We may also disclose your personal information to a third party as part of a sale of the assets of LinkedIn Corporation, a subsidiary, or division, or as the result of a change in control of the company or one of its affiliates, or in preparation for any of these events. Any third party to which LinkedIn transfers or sells LinkedIn's assets will have the right to continue to use the personal and other information that you provide to us in the manner set out in this Privacy Policy.</p>
      </div>
    </div>
  </div>
...
<div class="row primary-separator">
  <div class="section">
    ...
    <h2 id="choices-oblig">3. Your Choices &amp; Obligations</h2>

    <div class="row first">
      <h3 class="copy-header">3.1. Rights to Access, Correct, or Delete Your Information, and Closing Your Account</h3>
      <div class="brief">
        <p>You can change your LinkedIn information at any time by editing your profile, deleting content that you have posted, or by closing your account. You can also ask us for additional information we may have about your account.</p>
      </div>
      <div class="full">
        <p>You have a right to (1) access, modify, correct, or delete your personal information controlled by LinkedIn regarding your profile, (2) change or remove your content, and (3) close your account.  You can also contact us for any account information which is not on your profile or readily accessible to you. If you <a href="https://www.linkedin.com/secure/settings?closemyaccountstart=">close your account</a>, your information will generally be removed from the Service within 24 hours. We generally delete closed account information and will de-personalize any logs or other backup information within 30 days of account closure, except as noted below.</p>
        <p><strong>Please note:</strong> Information you have shared with others (for example, through InMail, network updates, content sharing, or LinkedIn Groups) or that others have copied may also remain visible after you have closed your account or deleted the information from your own profile. LinkedIn Groups content associated with closed accounts will show an unknown user as the source. In addition, you may not be able to access, correct, or eliminate any information about you that other Members copied or exported out of LinkedIn, because this information may not be in our control. Your public profile may be displayed in search engine results until the search engine refreshes its cache.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">3.2. Data Retention</h3>
      <div class="brief">
      ...
      <div class="full">
        <p>We retain the personal information you provide while your account is in existence or as needed to provide you services. LinkedIn may retain your personal information even after you have closed your account if retention is reasonably necessary to comply with our legal obligations, meet regulatory requirements, resolve disputes between Members, prevent fraud and abuse, or enforce this Privacy Policy and our User Agreement. We may retain personal information, for a limited period of time, if requested by law enforcement. LinkedIn's Customer Service may retain information for as long as is necessary to provide support-related reporting and trend analysis only, but we generally delete or de-personalize closed account data consistent with Section 3.1., except in the case of our plugin impression data, which we will try to de-personalize at the time of collection, but in any event, we will de-personalize within 7 days.</p>
      </div>
    </div>

    <div class="row last">
      <h3 class="copy-header">3.3. Your Obligations</h3>
      <div class="brief">
        <p>Please respect the terms of our User Agreement, our Policies, and your fellow LinkedIn Members.</p>
      </div>
      <div class="full">
        <p>As a Member, you have certain obligations to other Members. Some of these obligations are imposed by applicable law and regulations and others have become commonplace in communities of like-minded Members such as LinkedIn:</p>
        <ul>
          <li>You must, at all times, abide by the terms and conditions of the current Privacy Policy, User Agreement, and other policies of LinkedIn. This includes respecting all intellectual property rights that may belong to third parties, such as trademarks or copyrights.</li>
          <li>You must not upload or otherwise disseminate any information that may infringe on the rights of others or which may be deemed to be injurious, violent, offensive, racist, or xenophobic, or which may otherwise violate the purpose and spirit of LinkedIn and its community of Members.</li>
          <li>You must keep your username and password confidential and not share it with others.</li>
        <ul>
        <p>Any violation of these guidelines or those detailed in our User Agreement or elsewhere may lead to the restriction, suspension, or termination of your account at the sole discretion of LinkedIn.</p>
      </ul></ul></div>
    </div>
  </div>
...
<div class="row primary-separator">
  <div class="section">
    ...
    <h2 id="important-info">4. Important Information</h2>

    <div class="row first">
      <h3 class="copy-header">4.1. Minimum Age</h3>
      <div class="brief">
        <p>You have to meet LinkedIn's minimum age requirements to create an account.</p>
        
        <p class="safety-center">
          <a href="http://linkedin.custhelp.com/app/safety">Visit our Safety Center</a> for tips on using LinkedIn smartly and securely.
        </p>
      </div>
      <div class="full">
        ...
        <p>
          ...
          Please visit LinkedIn's <a href="http://linkedin.custhelp.com/app/safety">Safety Center</a> for additional information about safely using LinkedIn.
        </p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">4.2. TRUSTe and Safe Harbor</h3>
      <div class="brief">
        <p>
      ...
      <div class="full">
        <p>LinkedIn has been awarded TRUSTe's Privacy Seal signifying that this Privacy Policy and its practices have been reviewed by TRUSTe for compliance with <a href="/redir/redirect?url=http%3A%2F%2Fwww%2Etruste%2Ecom%2Fprivacy_seals_and_services%2Fconsumer_privacy%2Fprivacy-programs-requirements%2Ehtml&amp;urlhash=6YNM">TRUSTe's program requirements</a>.</p>
        <p>If you have questions or concerns regarding this Policy, you should first <a href="http://linkedin.custhelp.com/app/ask/path/ppq">contact LinkedIn</a>. If contacting us does not resolve your complaint, you may raise your complaint with TRUSTe by <a href="/redir/redirect?url=http%3A%2F%2Fwatchdog%2Etruste%2Ecom%2Fpvr%2Ephp%3Fpage%3Dcomplaint%26url%3D&amp;urlhash=y-Dy">Internet</a>, by fax at 415-520-3420, or mail to TRUSTe Safe Harbor Compliance Dept. (<a href="#how-to-contact-us">click for mailing address</a>). The complaint should include the name of company, the alleged privacy violation, your contact information, and whether you would like the particulars of your complaint shared with the company. The TRUSTe dispute resolution process shall be conducted in English. The TRUSTe program only covers information collected through <a href="/redir/redirect?url=http%3A%2F%2Fwww%2Elinkedin%2Ecom&amp;urlhash=VSkZ">www.linkedin.com</a>, and does not cover information that may be collected through downloaded software or Plugins.</p>
        <p>LinkedIn complies with the U.S.-E.U. and U.S.-Swiss Safe Harbor Frameworks as set forth by the U.S. Department of Commerce regarding the collection, use, and retention of personal data from European Union member countries and Switzerland. LinkedIn has certified that it adheres to the Safe Harbor Privacy Principles of notice, choice, onward transfer, security, data integrity, access, and enforcement. To learn more about the Safe Harbor program, and to view LinkedIn Œs certification, please visit <a href="/redir/redirect?url=http%3A%2F%2Fwww%2Eexport%2Egov%2Fsafeharbor%2F&amp;urlhash=XXR4">http://www.export.gov/safeharbor/</a>.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">4.3. Changes to this Privacy Policy</h3>
      <div class="brief">
        <p>We will notify you when we change this Privacy Policy.</p>
      </div>
      <div class="full">
        <p>We may change this Privacy Policy from time to time. If we make significant changes in the way we treat your personal information, or to the Privacy Policy, we will provide notice to you on the Service or by some other means, such as email.  Please review the changes carefully. If you agree to the changes, simply continue to use our Service. If you object to any of the changes to our terms and you no longer wish to use LinkedIn, you may <a href="https://www.linkedin.com/secure/settings?closemyaccountstart=">close your account</a>. Unless stated otherwise, our current Privacy Policy applies to all information that LinkedIn has about you and your account. Using LinkedIn after a notice of changes has been communicated to you or published on our Service shall constitute consent to the changed terms or practices.</p>
      </div>
    </div>

    <div class="row">
      <h3 class="copy-header">4.4. California's Shine the Light Law</h3>
      <div class="brief">
        <p>We don't share any of your personal information with third parties for direct marketing.</p>
      </div>
      <div class="full">
        <p>California Civil Code Section 1798.83, known as the "Shine The Light" law, permits our customers who are California residents to request and obtain from us a list of what personal information (if any) we disclosed to third parties for direct marketing purposes in the preceding calendar year and the names and addresses of those third parties.  Requests may be made only once a year and are free of charge. Under Section 1798.83, LinkedIn currently does not share any personal information with third parties for their direct marketing purposes.</p>
      </div>
    </div>

    <div class="row last">
      <h3 class="copy-header">4.5. Security</h3>
      <div class="brief">
        <p>We take privacy and security seriously and have enabled HTTPS access to our site (<a href="https://www.linkedin.com/settings/security-v2?goback=">turn on HTTPS</a>), in addition to existing SSL access over mobile devices. Also, please know that the Internet is not a secure environment, so be careful and select strong passwords.</p>
      </div>
      <div class="full">
...
<div class="row primary-separator" id="how-to-contact-us">
  <div class="contact">
    ...
    <div class="brief">
      ...
      <p>If you have questions or comments about this Privacy Policy, please contact us <a href="http://linkedin.custhelp.com/app/ask/path/ppq">online</a> or by physical mail at:</p>
    </div>
    <div class="us-address">
      <h3>For Members in the United States:</h3>
      <address class="vcard">
        <span class="fn org">LinkedIn Corporation</span>
        <span>Attn: Privacy Policy Issues</span>
        <div class="adr">
