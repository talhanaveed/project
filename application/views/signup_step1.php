...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/Project/styles/signup_step1.css">
			...
			<div class = "wrapper">
				<div class = "ex">
					<div id = "main">
						<div class = "heading">
							<h1>
								<span><strong>Johny</strong></span>, let's start creating your professional profile
							</h1>
						</div>
						...
						<div class = "tempp">
							<form>
								<ul class = "infolist">
									...
									<li>
										...
										<ul class = "inner">
											<li>
												<label for = "employed">
													<input type = "radio" name= "selectType" id="check1" value="employee" onclick="change(1)">
													Employed
												</label>
											</li>
											<li>
												<label for = "seeker">
													<input type = "radio" name= "selectType" id="check2" value="jobseeker" onclick="change(2)">
													Job Seeker
												</label>
											</li>
											<li>
												<label for = "student">
													<input type = "radio" name= "selectType" id="check1" value="student" onclick="change(3)">
													Student
												</label>
											</li>
										</ul>
								...
								<div class = "btn">
									<input type = "button" value = "Create my profile">
								</div>
								<div class = "last">
