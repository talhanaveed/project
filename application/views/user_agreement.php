					...
					<div id = "mid_wrapper">
						<div class = "row">
							<div class = "row_wrapper">
								...
								<div class = "row_cont">
									<p>Welcome, and thanks for using LinkedIn! When you use our products and services, you're agreeing to our terms, so please take a few minutes to read over the User Agreement below.</p>
						...
						<div class = "sec">
							<h2 id = "intro_head">1. Introduction
								<span class = "last_revised">Last revised on September 12, 2013</span>
							</h2>
							...
							<div class = "layer">
								...
								<div class = "full">
									<p id = "spc">Our User Agreement has been updated;
										<a href = "#">click here for a summary of the changes.</a>
									</p>
									<h3>1.1. Purpose</h3>
							...
							<div class = "layer_last">
								<h3 class = "sub_head">1.2. Scope and Intent</h3>
								<div class = "brief">
						...
						<div class = "separator">
							<div class = "sec">
								<h2 id = "obligation">2. Your Obligations</h2>
								<div class = "layer">
									<h3 class = "sub_head">2.1. Applicable laws and this Agreement</h3>
									<div class = "brief">
										<p>Some promises you make to us in this Agreement:</p>
									...
									<div class = "full">
										...
										<ul>
											...
											<li>
												<a href = "#">Complaints Regarding Content Posted on the LinkedIn Website</a>; and
											</li>
											<li>
												<a href = "#">LinkedIn's Privacy Policy</a>.
											</li>
										</ul>
									</div>
								</div>
								...
								<div class = "layer">
									<h3 class = "sub_head">2.2. License and warranty for your submissions to LinkedIn</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">2.3. Service Eligibility</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">2.4. Your Membership</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">2.6. Payment</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">2.8. Notifications and Service Messages</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">2.9. LinkedIn Applications</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">2.10. User-to-User Communication and Sharing (LinkedIn Groups, Answers, Updates, Company Pages, etc.)</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">2.11. Privacy</h3>
									<div class = "brief">
								...
								<div class = "layer_last">
									<h3 class = "sub_head">2.13. Contributions to LinkedIn</h3>
									<div class = "brief">
						...
						<div class = "separator">
							<div class = "sec">
								<h2 id = "obligation">3. Your Rights</h2>
								<div class = "layer">
									<div class = "brief">
						...
						<div class = "separator">
							<div class = "sec">
								<h2 id = "obligation">4. Our Rights & Obligations</h2>
								<div class = "layer">
									<h3 class = "sub_head">4.1. Services Availability</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">4.2. Third Party Sites and Developers</h3>
									<div class = "brief">
								...
								<div class = "layer_last">
									<h3 class = "sub_head">4.5. Intellectual Property Notices</h3>
									<div class = "brief">
						...
						<div class = "separator">
							<div class = "sec">
								<h2 id = "obligation">7. Termination</h2>

								<div class = "layer">
									<h3 class = "sub_head">7.1. Mutual rights of termination</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">7.2. Misuse of the Services</h3>
								...
								<div class = "layer_last">
									<h3 class = "sub_head">7.3. Effect of Termination</h3>
									<div class = "full-no-brief">
						...
						<div class = "separator">
							<div class = "sec">
								<h2 id = "obligation">8. Dispute Resolution</h2>

								<div class = "layer">
									<h3 class = "sub_head">8.1. Law and Forum for Legal Disputes</h3>
									<div class = "brief">
								...
								<div class = "layer_last">
									<h3 class = "sub_head">8.2. Arbitration Option</h3>
									<div class = "brief">
						...
						<div class = "separator">
							<div class = "sec">
								<h2 id = "obligation">9. General Terms</h2>

								<div class = "layer">
									<h3 class = "sub_head">9.1. Severability</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">9.2. Language</h3>
									<div class = "full-no-brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">9.3. Notices and Service of Process</h3>
									<div class = "full-no-brief">
										<p>In addition to Section 2.8. ("Notices and Service Messages"), we may notify you via postings on <a href = "#">www.linkedin.com</a>. You may contact us <a href = "#">here</a>. Or via mail or courier at: LinkedIn Corporation ATTN: Legal Department 2029 Stierlin Court Mountain View, CA 94043 USA Additionally, LinkedIn accepts service of process at this address. Any notices that you provide without compliance with this section shall have no legal effect.</p>
									</div>
								</div>

								<div class = "layer">
									<h3 class = "sub_head">9.4. Entire Agreement</h3>
									<div class = "full-no-brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">9.7. No Injunctive Relief</h3>
									<div class = "brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">9.8. Beneficiaries</h3>
									<div class = "full-no-brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">9.9. Assignment and Delegation</h3>
									<div class = "brief">
								...
								<div class = "layer_last">
									<h3 class = "sub_head">9.10. Potential Other Rights and Obligations</h3>
									<div class = "full-no-brief">
						...
						<div class = "separator">
							<div class = "sec">
								<h2 id = "obligation">10. LinkedIn "DOs" and "DON'Ts."</h2>
								<div class = "layer">
									<div class = "full-no-brief">
								...
								<div class = "layer">
									<h3 class = "sub_head">10.1. Do undertake the following:</h3>
									<div class = "brief">
									<p>Here's a list of some of the specific things we ask you to do and not do on LinkedIn. If you want a high-level summary of these, please check out our <a href = "#">Professional Community Guidelines</a>.</p>
									</div>
									<div class = "full">
										<ol>
											...
											<li>Review and comply with our <a href = "#">Privacy Policy</a>;</li>
								...
								<div class = "layer_last">
									<h3 class = "sub_head">10.2. Don't undertake the following:</h3>
									<div class = "full-no-brief">
										<ol>
											...
											<li>Duplicate, license, sublicense, publish, broadcast, transmit, distribute, perform, display, sell, rebrand, or otherwise transfer information found on LinkedIn (excluding content posted by you) except as permitted in this Agreement, LinkedIn's developer terms and policies, or as expressly authorized by LinkedIn;</li>
											...
											<li>Deep-link to the Site for any purpose, (i.e. creating or posting a link to a LinkedIn web page other than LinkedIn's home page) unless expressly authorized in writing by LinkedIn or for the purpose of promoting your profile or a Group on LinkedIn as set forth in the <a href = "#">Brand Guidelines</a>;</li>
											...
											<li>Infringe or use LinkedIn's brand, logos or trademarks, including, without limitation, using the word “LinkedIn” in any business name, email, or URL or including LinkedIn's trademarks and logos except as provided in the <a href = "#">Brand Guidelines</a> or as expressly permitted by LinkedIn;</li>
						...
						<div class = "separator">
							<div class = "sec">
								<h2 id = "obligation">11. Complaints Regarding Content Posted on the LinkedIn Website</h2>
								<div class = "layer_last">
									<div class = "brief">
							...
							<div class = "sec">
								<div class = "contact">
									<div class = "brief">
										...
										<p>If you have questions or comments about this User Agreement, please contact us <a href = "#">online</a> or by physical mail at:</p>
									</div>

									<div class = "address">
										<h3>For Members in the United States:</h3>
										<!-- <p>LinkedIn Corporation</p>
										<p>Attn: User Agreement Issues</p>
										<p>2029 Stierlin Court</p>
										<p>Mountain View, CA 94043</p>
										<p>USA</p> -->
										<address>LinkedIn Corporation Attn: User Agreement Issues 2029 Stierlin Court Mountain View, CA 94043 USA</address>
									</div>

									<div class = "address">
										<h3>For Members in the United States:</h3>
										<address>LinkedIn Ireland Limited Attn: User Agreement Issues Gardner House, Wilton Place, Wilton Plaza, Dublin 2 Ireland
										</address>
									</div>
								</div>
