                ...
                <div id = "side-bar">
                    ...
                    <div id = "know">
                        ...
                        <ul class = "side-ul">
                            ...
                            <li class = "side-li">
                                <img src = "/Project/assets/img/person.png" class = "photo" />
                    ...
                    <!-- <div class="add3">
                        <ul class="gallery clearfix">
                            <li><a href="/Project/assets/img/add7.jpg" rel = "prettyPhoto">
                                <img src="/Project/assets/img/add7.jpg" alt = "Linkedin - Special Feature" title = "Click" />
                            </a></li>
                        </ul>
                    </div> -->
                    <div class="add3" style = "display: none">
                        <ul class="gallery clearfix">
                            <li><a href="/Project/assets/img/add4.jpg" rel = "prettyPhoto">
                                <img src="/Project/assets/img/add4.jpg" alt = "Linkedin - Special Feature" title = "Click" />
                            </a></li>
                        </ul>
                    </div>
                    <div class="add3">
