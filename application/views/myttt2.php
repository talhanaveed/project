...
<div align="center">
	...
	<div id="atc_bar" align="center">
		...
		<div id="loader">
			...
			<div align="center" id="atc_loading" style="display:none"><img src="/Project/assets/img/loading.gif" alt="Loading" /></div>
			<div id="attach_content" style="display:none">
				...
				<div id="atc_total_image_nav" >
					<a href="#" id="prev"><img src="/project/assets/img/myttt/prev.png"  alt="Prev" border="0" /></a><a href="#" id="next"><img src="/project/assets/img/myttt/next.png" alt="Next" border="0" /></a>
				</div>
	...
	$(document).ready(function(){	
		...
		function parse_link ()
		{
			...
			else
			{
				...
				$.post("test2/go?url="+escape($('#url').val()), {}, function(response){
