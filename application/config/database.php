...
$db['heroku']['hostname'] = 'ec2-54-227-242-149.compute-1.amazonaws.com';
$db['heroku']['username'] = 'arfakmoggiuvqa';
$db['heroku']['password'] = 'X9DXDr3jQQuM-CeytZrkMHDQZJ';
$db['heroku']['database'] = 'd7jtni3lvcnr0m';
